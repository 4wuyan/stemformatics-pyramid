...
psql -U portaladmin portal_beta -c "INSERT INTO stemformatics.configs (ref_type,ref_id) values('DatasetGCTFiles','/var/www/pylons-data/prod/GCTFiles/');"
...
psql -U portaladmin portal_beta -c "INSERT INTO stemformatics.configs (ref_type,ref_id) values('debug','false');"
