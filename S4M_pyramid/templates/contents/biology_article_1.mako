...
<%def name="includes()">
    ...
    <div class="rightColumn">
        <div class="mainTextColumn">
            ...
            <div class="mainText">
                    ...
                    <div class="articleImageCaption">
                        <img class="small" src="${h.url('/images/contents/biology_1.png')}" />
                        <div class="caption">
        ...
        <div class="sideColumn">
            <div id="searchList" class="clear">
                <div class="search"><a href="${h.url('/contents/glossary')}">GLOSSARY >></a></div>
                <div class="search"><a href="${h.url('/contents/biologists')}">INFORMATION FOR <span>BIOLOGISTS</span> >></a></div>
                <div class="search"><a href="${h.url('/contents/public')}">INFORMATION FOR <span>GENERAL PUBLIC</span> >> </a></div>
                
            </div>
            <div class="sideColumnList">
                <h1>Articles relating to this topic</h1>
                <div class="ruler"></div>
                <div class=news>
                    <div class="showText">
                        <h3>TEMPORT ULTRICES</h3>
                        <div class="name">Name of publication or institution</div>
                        <div class="date">19.11.2010</div>
                        <div class="text">Professor Steven Bustin of University of Blaghdeburough nam
