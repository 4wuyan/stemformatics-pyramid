...
<%def name="includes()">
    ...
    <div class="leftColumn">	
        ...
        <div class="mainTextColumn">
            ...
            <h2>Site Features - Bar Graph <a id=calculationLink href="${h.url('/${c.site_name}_data_methods.pdf')}">Download data methods doc</a></h2>
            <div class="innerDiv">
                <img src="${h.url('/images/contents/siteFeatures/siteFeature_barGraph.png')}" />
                <div id="legend">
                    <h3>Legend for Bar Graph</h3>
                    <ol>
                        ...
                        <li>Average expression value for the probe - hover over bar to show label</li>
                        <li>Error Bar of +/- 1 standard deviation  </li>
