...
<%def name="includes()">   
    ...
    <div id="wb_background" class="wb_background_divs">    
        <div id="wb_background_inner_div">
            ...
            <div class="title margin_bottom_small">User Audit Report <div data-id="user" class="export margin_left_small generic_orange_button"><a href="#!">Export User Audit Report</a></div></div> 
            <table id="user_audit_report" class="margin_bottom_large">
                <thead>
                    <tr>
            ...
            <div class="title margin_bottom_small">Dataset Audit Report <div data-id="dataset" class="export margin_left_small generic_orange_button"><a href="#!">Export Dataset Audit Report</a></div></div> 
            <table id="dataset_audit_report" class="margin_bottom_large">
                <thead>
                    <tr>
            ...
            <div class="title margin_bottom_small">Dataset User Audit Report <div data-id="dataset_user" class="export margin_left_small generic_orange_button"><a href="#!">Export Dataset User Audit Report</a></div></div> 
            <table id="dataset_user_audit_report" class="margin_bottom_large">
                <thead>
                    <tr>
                ...
                <tbody>
                    %for row in c.result['dataset_user']: 
                        <tr>
                            <td>${row['handle']}</td>
                            <td>${row['ref_id']}</td>
                            <td>${row['username']}</td>
            ...
            <div class="title margin_bottom_small">Gene Audit Report <div data-id="gene" class="export margin_left_small generic_orange_button"><a href="#!">Export Gene Audit Report</a></div></div> 
            <table id="gene_audit_report" class="margin_bottom_large">
                <thead>
                    <tr>
                        <th class="long">Gene</th>
                        <th class="long">ID</th>
                        <th class="long">Count</th>
                ...
                <tbody>
                    %for row in c.result['gene']: 
                        <tr>
                            <td>${row['associated_gene_name']}</td>
                            <td>${row['ref_id']}</td>
                            <td>${row['c']}</td>
                        </tr>
                    %endfor
            ...
            <div class="title margin_bottom_small">Controller Audit Report <div data-id="controller" class="export margin_left_small generic_orange_button"><a href="#!">Export Controller Audit Report</a></div></div> 
            <table id="controller_audit_report" class="margin_bottom_large">
                <thead>
                    <tr>
                ...
                <tbody>
                    %for row in c.result['controller']: 
                        <tr>
