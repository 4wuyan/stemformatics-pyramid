                    ...
                    <div class="wb_sub_menu_container">
                        ...
                        <div class="wb_help_showing wb_menu_items">
                            <div class="wb_help_inner_div">                
                                ...
                                <p>The Pearson distance was chosen as the default analysis calculation due to the fact it is widely used and accepted as a measure of the strength of linear dependence.<p>
                                ...
                                <p>The default settings for the ${c.site_name} analysis of Gene Neighbourhood are shown below.</p>
                            </div>
            ...
            <div class="tables">
                <table>
                    ...
                    <tr>
                        ...
                        <td>This was chosen due to the fact it is widely used and accepted as a measure of the strength of linear dependence</td>
                    </tr>
                    <tr>
                        <td>filter data</td>
                        <td></td>
