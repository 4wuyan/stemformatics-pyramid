 ...
 * calculating the min and max values of the graph */
 ...
 function run_box_bar_gene_expression_graph(colours,graphDiv, barPlotOption, sortByOption, show_min_y_axis, legend_required,ref_name, main_title, whiskers_needed, scaling_required,dataset_data,probe_name_for_tooltip,ref_type){
    ...
    if (first_option != "Sample_Type" ) {
            setup_colours_for_group(sort_option_array.sort(sortAlphaNum_array), sort_colour,
    ...
    if ((sortByOption.split(',')[0] == 'Sample_Type' || sortByOption.split(',')[1] == 'Sample_Type')) {
      sort_option_array = dataset_data["sampleTypeDisplayOrder"].split(',');
    ...
    var options = {
      ...
      probe_name_for_tooltip:probe_name_for_tooltip,
        ...
        bar_graph: barPlotOption,
        box_width: 50,
        box_width_wiskers: 15,
        second_sort_by_order: "no", //Order of the second_sort_by state on the x axis
        sample_type_order: sort_option_array.join(), //dataset_data["sampleTypeDisplayOrder"], //Order of the sample types on the x axis
        ...
        margin:{top: 250, left: 130, bottom: 400, right: 270},
        initial_padding: 10,
        legend_on_x_axis: "no",
        axis: "top",
        ...
        display: {hoverbars: "yes", error_bars: "yes", legend: legend_required, horizontal_lines: "yes", vertical_lines: "yes", x_axis_labels: x_axis_labels_required, y_axis_title: "yes", horizontal_grid_lines: "yes"},
    ...
    var instance = biojsvisboxplot(options);
